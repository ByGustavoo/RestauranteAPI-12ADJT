...
public record CreateUserRequest(
        ...
        @Schema(description = "Login do usuário", example = "joaosilva123", minLength = 10, maxLength = 20)
        String login,

        @NotBlank(message = "O campo 'senha' é obrigatório!")
        @Size(min = 12, message = "A senha deve ter no mínimo 12 caracteres!")
        @Schema(description = "Senha do usuário", example = "senhaSegura123!", minLength = 12)
        String senha,
        ...
        @Schema(description = "Tipo de usuário no sistema: 1 = DONO, 2 = CLIENTE", example = "1", minLength = 1, maxLength = 2)
        Integer tipoUsuario
